    ...
    <div class="hostpn-container">
        <?php while (have_posts()):
            ...
            <article class="hostpn-accommodation-single" data-accommodation-id="<?php echo esc_attr($accommodation_id); ?>">
                            ...
                            foreach ($accommodation_features as $category_key => $category_data) {
                                ...
                                if (!empty($active_features) || (!empty($custom_features) && is_array($custom_features))):
                                    ...
                                    <div class="hostpn-feature-category">
                                        <div class="hostpn-toggle-header"
                                            data-toggle="<?php echo esc_attr($category_key); ?>-features">
                                            <h4>
                                                <i
                                                    class="material-icons-outlined hostpn-icon-small"><?php echo esc_attr($category_data['icon']); ?></i>
                                                <?php echo esc_html($category_data['title']); ?>
                                            </h4>
                                            <i class="material-icons-outlined hostpn-toggle-icon">sort</i>
                                        </div>
                                        <div
                                            class="hostpn-toggle-content hostpn-toggle-<?php echo esc_attr($category_key); ?>-features">
                ...
                <?php
                $gallery_images = get_post_meta($accommodation_id, 'hostpn_accommodation_gallery', true);
                if (!empty($gallery_images)):
                    ...
                    if (!empty($gallery_images)):
                        ?>
                        <div class="hostpn-accommodation-gallery">
                            <div class="hostpn-carousel" data-auto-init="true" data-autoplay="true" data-autoplay-speed="5000"
                                data-loop="true" data-dots="true" data-nav="true" data-counter="true">
                                <?php foreach ($gallery_images as $image_id):
                                    $image_url = wp_get_attachment_image_url($image_id, 'large');
                                    $image_alt = get_post_meta($image_id, '_wp_attachment_image_alt', true);
                                    if ($image_url):
                                        ?>
                                        <div class="hostpn-gallery-slide">
                ...
                <nav class="hostpn-accommodation-navigation">
                    ...
                    <div class="hostpn-back-to-archive">
                        <a href="<?php echo esc_url(get_post_type_archive_link('hostpn_accommodation')); ?>"
                            class="hostpn-btn">

 ...
 */
define('HOSTPN_VERSION', '1.0.0');

/**
 * The code that runs during plugin activation.
 * This action is documented in includes/class-hostpn-activator.php
 */
function hostpn_activate() {
	require_once plugin_dir_path(__FILE__) . 'includes/class-hostpn-activator.php';
	HOSTPN_Activator::activate();
}
register_activation_hook(__FILE__, 'hostpn_activate');

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-hostpn-deactivator.php
 */
function hostpn_deactivate() {
	require_once plugin_dir_path(__FILE__) . 'includes/class-hostpn-deactivator.php';
	HOSTPN_Deactivator::deactivate();
}
register_deactivation_hook(__FILE__, 'hostpn_deactivate');

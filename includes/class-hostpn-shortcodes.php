...
class HOSTPN_Shortcodes {
          ...
          <div class="hostpn-navigation">
            <div class="hostpn-display-table hostpn-width-100-percent">
              <div class="hostpn-display-inline-table hostpn-width-33-percent hostpn-img-hover-zoom">
                <a href="<?php echo esc_url(get_permalink(HOSTPN_i18n::get_post($hostpn_page_accommodation))); ?>">
              ...
              <div class="hostpn-display-inline-table hostpn-width-33-percent hostpn-img-hover-zoom">
                <a href="<?php echo esc_url(get_permalink(HOSTPN_i18n::get_post($hostpn_page_part))); ?>">
              ...
              <div class="hostpn-display-inline-table hostpn-width-33-percent hostpn-img-hover-zoom">
                <a href="<?php echo esc_url(get_permalink(HOSTPN_i18n::get_post($hostpn_page_host))); ?>">
  ...
  public function hostpn_call_to_action($atts) {
    ...
    ob_start();
    ?>
      <div class="hostpn-call-to-action hostpn-text-align-center hostpn-pt-30 hostpn-pb-50 <?php echo $hostpn_call_to_action_class; ?>">
        <div class="hostpn-call-to-action-icon">
          <i class="material-icons-outlined hostpn-font-size-75 hostpn-color-main-0"><?php echo $hostpn_call_to_action_icon; ?></i>
        </div>

        <h4 class="hostpn-call-to-action-title hostpn-text-align-center hostpn-mt-10 hostpn-mb-20"><?php echo $hostpn_call_to_action_title; ?></h4>
        
        <?php if (!empty($hostpn_call_to_action_content)): ?>
          <p class="hostpn-text-align-center"><?php echo $hostpn_call_to_action_content; ?></p>
        <?php endif ?>

        <?php if (!empty($hostpn_call_to_action_button_text)): ?>
          <div class="hostpn-text-align-center hostpn-mt-20">
            <a class="hostpn-btn hostpn-btn-transparent wph-margin-auto <?php echo $hostpn_call_to_action_button_class; ?>" <?php echo ($hostpn_call_to_action_button_blank) ? 'target="_blank"' : ''; ?> href="<?php echo $hostpn_call_to_action_button_link; ?>" <?php echo (!empty($hostpn_call_to_action_button_data_key) && !empty($hostpn_call_to_action_button_data_value)) ? $hostpn_call_to_action_button_data_key . '="' . $hostpn_call_to_action_button_data_value . '"' : ''; ?>><?php echo $hostpn_call_to_action_button_text; ?></a>
          </div>
        <?php endif ?>
      </div>
    <?php 
